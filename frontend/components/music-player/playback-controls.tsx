...
const sizeConfig = {
  ...
  large: {
    ...
    playBtn: "w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16",
    playIcon: "w-5 h-5 sm:w-6 sm:h-6 md:w-7 md:h-7",
    ctrlBtn: "w-9 h-9 sm:w-10 sm:h-10 md:w-12 md:h-12",
    ctrlIcon: "w-5 h-5 sm:w-6 sm:h-6",
    secondaryIcon: "w-4 h-4 sm:w-5 sm:h-5",
  },
  xlarge: {
    gap: "gap-4 sm:gap-6 md:gap-8",
    playBtn: "w-14 h-14 sm:w-16 sm:h-16 md:w-20 md:h-20",
    playIcon: "w-6 h-6 sm:w-7 sm:h-7 md:w-9 md:h-9",
    ctrlBtn: "w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14",
    ctrlIcon: "w-5 h-5 sm:w-6 sm:h-6 md:w-7 md:h-7",
    secondaryIcon: "w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6",
  },
};
